...
const containerTelaCadastro = StyleSheet.create({
    preenchimentoFundoScrollView:{backgroundColor:'#007bff',padding:10,borderWidth:2,borderColor:'#9400d3',flex:1},
...
const textTelaDeCadastro = StyleSheet.create({
    ...
    textTextImput:{borderWidth:2,borderColor:'#9400d3',backgroundColor:'#fff', borderRadius:30,height:40,width:'100%',color:'white',textAlign:'center'}
    
})

const botao = StyleSheet.create({
    viewBotao:{flexDirection:'column', width:'100%',alignItems:'center',margin:'3%',justifyContent:'center'},
    botaoCadastrar:{backgroundColor:'#ffff',width:wp(44),height:hp(5), borderRadius:30,margin:5},
    textBotao:{color:'#007bff',textAlign:'center',marginTop:5}
})
